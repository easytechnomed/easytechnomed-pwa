...
## Corpus Check
- Large corpus: 383 files · ~565,493 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 6018 nodes · 9369 edges · 115 communities detected
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output
- Edge kinds: contains: 5669 · calls: 2717 · MODIFIES: 612 · ON_BRANCH: 116 · PARENT_OF: 114 · imports: 52 · imports_from: 40 · method: 34 · inherits: 13 · implements: 2


## Input Scope
- Requested: auto
- Resolved: committed (source: default-auto)
- Included files: 383 · Candidates: 668
- Excluded: 30 untracked · 122554 ignored · 1 sensitive · 0 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `dcd11d4`
...
Cohesion: 0.04
Nodes (43): filter, COMMON_LAB_UNITS, isQualitativeAbnormal(), isOutOfRange(), isQualitativeAbnormal(), isOutOfRange(), menuButtonStyle, activeMenuButtonStyle (+35 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (85): isLikelyMobile(), loginSchema, CustomerLoginPage(), theme, PRECACHE_ROUTES, 005eea6 f, 026962b 1.1.33, 0afb0ac 2.0.19 (+77 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (46): metadata, metadata, callGemini(), POST(), serializeData(), GET(), serializeData(), GET() (+38 more)
...
Cohesion: 0.12
Nodes (10): registerSchema, metadata, outfit, metadata, viewport, Input, 20dc303 3.0.19, 2582be7 fixed zoom issue (+2 more)

### Community 32 - "Community 32"
Cohesion: 0.09
Nodes (10): theme, metadata, verifyToken(), requireUser(), requireAdmin(), requireSuperAdmin(), verifySuperAdminAPI(), JWT_SECRET (+2 more)

### Community 10 - "Community 10"
Cohesion: 0.06
Nodes (34): serializeData(), registrationSchema, GET(), POST(), isQualitativeAbnormal(), isOutOfRange(), parseMarkdownTokens(), layoutMarkdownLines() (+26 more)
...
Cohesion: 0.50
Nodes (1): DEFAULT_INITIAL_CHANGES

### Community 72 - "Community 72"
Cohesion: 0.39
Nodes (5): saveAuthenticatedSession(), getOrCreateOfflineSession(), getCachedSession(), isLocalSessionValid(), DEFAULT_OFFLINE_ADMIN
...
Cohesion: 0.33
Nodes (12): getAppUrl(), getPrimaryConfig(), getFallbackConfig(), createTransporter(), sendMailWithFallback(), sendPasswordResetEmail(), sendVerificationEmail(), sendApprovalEmail() (+4 more)
...
## Knowledge Gaps
- **3372 isolated node(s):** `quickRanges`, `filter`, `COMMON_LAB_UNITS`, `DLC_DEFINITIONS`, `menuButtonStyle` (+3367 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 116`** (2 nodes): `callGeminiModels()`, `POST()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 92`** (2 nodes): `parseNullableString()`, `POST()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 102`** (2 nodes): `serializeRegistration()`, `GET()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 114`** (2 nodes): `POST()`, `PUT()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 104`** (2 nodes): `serializeData()`, `GET()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 115`** (2 nodes): `processTestParameters()`, `GET()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 96`** (2 nodes): `DEFAULT_COLUMN_ORDER`, `DEFAULT_PDF_SETTINGS`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 113`** (1 nodes): `DEFAULT_INITIAL_CHANGES`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 62`** (1 nodes): `AppDatabase`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (1 nodes): `NetworkMonitor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 60`** (1 nodes): `SyncManager`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 105`** (2 nodes): `{ PrismaClient }`, `prisma`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 110`** (2 nodes): `{ PrismaClient }`, `prisma`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 111`** (2 nodes): `sampleReg`, `url`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `_d()` connect `Community 1` to `Community 2`, `Community 4`, `Community 98`, `Community 99`, `Community 103`?**
  _High betweenness centrality (0.108) - this node is a cross-community bridge._
- **Why does `SyncManager` connect `Community 60` to `Community 9`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **Why does `AppDatabase` connect `Community 62` to `Community 9`?**
  _High betweenness centrality (0.004) - this node is a cross-community bridge._
- **What connects `quickRanges`, `filter`, `COMMON_LAB_UNITS` to the rest of the system?**
  _3372 weakly-connected nodes found - possible documentation gaps or missing edges._
...
- **Should `Community 2` be split into smaller, more focused modules?**
  _Cohesion score 0.013639592706606678 - nodes in this community are weakly interconnected._