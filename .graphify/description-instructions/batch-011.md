# Node Description Batch 12 of 151
...
- "runtime_wasm_wr": "Wr()" | kind=code-symbol | source=scratch/generated-client/runtime/wasm.js:L6 | neighbors=[wasm.js, ge(), getAllModelExtensions(), H(), ka(), vt()]
- "runtime_wasm_zt": "zt()" | kind=code-symbol | source=scratch/generated-client/runtime/wasm.js:L5 | neighbors=[wasm.js, handleRequestError(), throwValidationError(), Ht(), xt(), Ye()]
- "scratch_backfill_counters": "scratch-backfill-counters.js" | kind=code-symbol | source=scratch-backfill-counters.js:L1 | neighbors=[dcd11d4 first commit, generateRandomSuffix(), main(), prisma, { PrismaClient }, 252e194 e]
- "scratch_test_patient_context": "test-patient-context.js" | kind=code-symbol | source=scratch/test-patient-context.js:L1 | neighbors=[dcd11d4 first commit, addPatientContextToValuesMap(), valuesMap1, valuesMap2, valuesMap3, 252e194 e]
- "scratch_test_user_cbc": "test-user-cbc.js" | kind=code-symbol | source=scratch/test-user-cbc.js:L1 | neighbors=[dcd11d4 first commit, calculateAllDependents(), inputValues, result, testDefinition, 252e194 e]
- "sync_syncmanager_syncmanager_triggerauthrequired": ".triggerAuthRequired()" | kind=code-symbol | source=lib/offline/sync/syncManager.js:L72 | neighbors=[SyncManager, .bootstrapInitialData(), .processGetOperations(), .processPendingPatientResults(), .processPostOperations(), .processPutOperations()]
- "check_route": "route.js" | kind=code-symbol | source=app/api/auth/check/route.js:L1 | neighbors=[GET(), HEAD(), dcd11d4 first commit, 252e194 e, d446d11 fixed code]
