# Node Description Batch 17 of 151
...
- "samples_route": "route.js" | kind=code-symbol | source=app/api/registrations/[id]/samples/route.js:L1 | neighbors=[dcd11d4 first commit, GET(), POST(), serializeData(), 252e194 e]
- "scratch_backfill": "scratch-backfill.js" | kind=code-symbol | source=scratch-backfill.js:L1 | neighbors=[dcd11d4 first commit, main(), prisma, { PrismaClient }, 252e194 e]
- "scratch_backfill_incentives": "scratch-backfill-incentives.js" | kind=code-symbol | source=scratch-backfill-incentives.js:L1 | neighbors=[dcd11d4 first commit, main(), prisma, { PrismaClient }, 252e194 e]
- "scratch_bootstrap_dates": "bootstrap-dates.js" | kind=code-symbol | source=scratch/bootstrap-dates.js:L1 | neighbors=[dcd11d4 first commit, main(), prisma, { PrismaClient }, 252e194 e]
- "scratch_check_data": "check-data.js" | kind=code-symbol | source=scratch/check-data.js:L1 | neighbors=[dcd11d4 first commit, main(), prisma, { PrismaClient }, 252e194 e]
