# Node Description Batch 38 of 151
...
- "lib_mail_createtransporter": "createTransporter()" | kind=code-symbol | source=lib/mail.js:L28 | neighbors=[mail.js, sendMailWithFallback()]
- "lib_mail_getfallbackconfig": "getFallbackConfig()" | kind=code-symbol | source=lib/mail.js:L16 | neighbors=[mail.js, sendMailWithFallback()]
- "lib_mail_getprimaryconfig": "getPrimaryConfig()" | kind=code-symbol | source=lib/mail.js:L7 | neighbors=[mail.js, sendMailWithFallback()]
- "lib_mail_sendrejectionemail": "sendRejectionEmail()" | kind=code-symbol | source=lib/mail.js:L202 | neighbors=[mail.js, sendMailWithFallback()]
...
- "login_loginpageclient_customerloginpage": "CustomerLoginPage()" | kind=code-symbol | source=app/(customer)/auth/login/LoginPageClient.js:L30 | neighbors=[LoginPageClient.js, isLikelyMobile()]
- "login_loginpageclient_islikelymobile": "isLikelyMobile()" | kind=code-symbol | source=app/(customer)/auth/login/LoginPageClient.js:L14 | neighbors=[LoginPageClient.js, CustomerLoginPage()]
