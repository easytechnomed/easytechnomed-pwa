# Node Description Batch 39 of 151
...
- "print_billhtmlgenerator_formatdate": "formatDate()" | kind=code-symbol | source=lib/offline/print/billHtmlGenerator.js:L5 | neighbors=[billHtmlGenerator.js, generateOfflineBillHtml()]
- "print_billhtmlgenerator_numbertowords": "numberToWords()" | kind=code-symbol | source=lib/offline/print/billHtmlGenerator.js:L19 | neighbors=[billHtmlGenerator.js, generateOfflineBillHtml()]
- "print_billpdfgenerator_drawcode39barcode": "drawCode39Barcode()" | kind=code-symbol | source=lib/offline/print/billPdfGenerator.js:L20 | neighbors=[billPdfGenerator.js, generateOfflineBillPdf()]
- "print_billpdfgenerator_formatdate": "formatDate()" | kind=code-symbol | source=lib/offline/print/billPdfGenerator.js:L49 | neighbors=[billPdfGenerator.js, generateOfflineBillPdf()]
- "print_billpdfgenerator_numbertowords": "numberToWords()" | kind=code-symbol | source=lib/offline/print/billPdfGenerator.js:L63 | neighbors=[billPdfGenerator.js, generateOfflineBillPdf()]
...
- "reset_password_route": "route.js" | kind=code-symbol | source=app/api/auth/reset-password/route.js:L1 | neighbors=[dcd11d4 first commit, POST()]
