# Node Description Batch 51 of 151
...
- "sync_syncmanager_syncmanager_bootstrapinitialdata": ".bootstrapInitialData()" | kind=code-symbol | source=lib/offline/sync/syncManager.js:L162 | neighbors=[SyncManager, .triggerAuthRequired()]
- "sync_syncmanager_syncmanager_clearallerrors": ".clearAllErrors()" | kind=code-symbol | source=lib/offline/sync/syncManager.js:L90 | neighbors=[SyncManager, .notifyState()]
- "sync_syncmanager_syncmanager_processgetoperations": ".processGetOperations()" | kind=code-symbol | source=lib/offline/sync/syncManager.js:L900 | neighbors=[SyncManager, .triggerAuthRequired()]
- "sync_syncmanager_syncmanager_processpendingpatientresults": ".processPendingPatientResults()" | kind=code-symbol | source=lib/offline/sync/syncManager.js:L1063 | neighbors=[SyncManager, .triggerAuthRequired()]
- "sync_syncmanager_syncmanager_processpostoperations": ".processPostOperations()" | kind=code-symbol | source=lib/offline/sync/syncManager.js:L701 | neighbors=[SyncManager, .triggerAuthRequired()]
- "sync_syncmanager_syncmanager_processputoperations": ".processPutOperations()" | kind=code-symbol | source=lib/offline/sync/syncManager.js:L827 | neighbors=[SyncManager, .triggerAuthRequired()]
