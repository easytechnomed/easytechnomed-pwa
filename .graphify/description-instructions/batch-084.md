# Node Description Batch 85 of 151
...
- "generated_client_index_d_patientresultuncheckedupdatemanywithoutregistrationnestedinput": "PatientResultUncheckedUpdateManyWithoutRegistrationNestedInput" | kind=code-symbol | source=scratch/generated-client/index.d.ts:L44279 | neighbors=[index.d.ts]
- "generated_client_index_d_patientresultuncheckedupdatemanywithouttestparameterinput": "PatientResultUncheckedUpdateManyWithoutTestParameterInput" | kind=code-symbol | source=scratch/generated-client/index.d.ts:L54153 | neighbors=[index.d.ts]
- "generated_client_index_d_patientresultuncheckedupdatemanywithouttestparameternestedinput": "PatientResultUncheckedUpdateManyWithoutTestParameterNestedInput" | kind=code-symbol | source=scratch/generated-client/index.d.ts:L44571 | neighbors=[index.d.ts]
- "generated_client_index_d_patientresultuncheckedupdatewithoutregistrationinput": "PatientResultUncheckedUpdateWithoutRegistrationInput" | kind=code-symbol | source=scratch/generated-client/index.d.ts:L53855 | neighbors=[index.d.ts]
- "generated_client_index_d_patientresultuncheckedupdatewithouttestparameterinput": "PatientResultUncheckedUpdateWithoutTestParameterInput" | kind=code-symbol | source=scratch/generated-client/index.d.ts:L54143 | neighbors=[index.d.ts]
- "generated_client_index_d_patientresultupdateargs": "PatientResultUpdateArgs" | kind=code-symbol | source=scratch/generated-client/index.d.ts:L23000 | neighbors=[index.d.ts]
