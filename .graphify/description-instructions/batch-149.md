# Node Description Batch 150 of 151
...
- "sync_syncmanager_syncmanager_buildsyncpayload": ".buildSyncPayload()" | kind=code-symbol | source=lib/offline/sync/syncManager.js:L117 | neighbors=[SyncManager]
