...
export default function PWARegister() {
  useEffect(() => {
    // Global PWA beforeinstallprompt capture (ensures prompt is never missed by late-mounting modals)
    const handleBeforeInstallPrompt = (e) => {
      e.preventDefault();
      window.deferredPwaPrompt = e;
      window.dispatchEvent(new CustomEvent("pwa-prompt-available", { detail: e }));
      console.log("[PWA] Global beforeinstallprompt captured successfully");
    };
            ...
            >
              ...
              >
                ...
                <button
                  ...
                  onMouseOver={(e) =>
                    (e.currentTarget.style.backgroundColor = "#0d645d")
                  }
                  onMouseOut={(e) =>
